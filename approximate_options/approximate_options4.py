...
approximate_options4 = [
    {
        "x": [convert_variables_without_trainable([x, x]) for x in list(np.arange(-5, 5, 0.2))],
        "x_validate": [convert_variables_without_trainable([x, x]) for x in list(np.arange(-5, 5, 0.02))],
