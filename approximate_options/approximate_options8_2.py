...
approximate_options8_2 = [
    {
        ...
        "params": convert_variables([5 for x in range(81)]),
...
approximate_options8_2_white_noise = [
    copy.deepcopy(x) for x in approximate_options8_2
]
for x in approximate_options8_2_white_noise:
    x["noise_type"] = "white_noise"
    x["seed"] = 42
"""
approximate_options8_2_gaussian_noise = [
    copy.deepcopy(x) for x in approximate_options8_2
]
for x in approximate_options8_2_gaussian_noise:
    x["noise_type"] = "gaussian_noise"
    x["seed"] = 42
    x["mean"] = 1
    x["std"] = 5

approximate_options8_2_salt_and_papper_noise = [
    copy.deepcopy(x) for x in approximate_options8_2
]
for x in approximate_options8_2_salt_and_papper_noise:
