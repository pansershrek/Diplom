...
approximate_options9_3_white_noise = [
    copy.deepcopy(x) for x in approximate_options9_3
]
for x in approximate_options9_3_white_noise:
    x["noise_type"] = "white_noise"
    x["seed"] = 42
"""
approximate_options9_3_gaussian_noise = [
    copy.deepcopy(x) for x in approximate_options9_3
]
for x in approximate_options9_3_gaussian_noise:
    x["noise_type"] = "gaussian_noise"
    x["seed"] = 42
    x["mean"] = 1
    x["std"] = 5

approximate_options9_3_salt_and_papper_noise = [
    copy.deepcopy(x) for x in approximate_options9_3
]
for x in approximate_options9_3_salt_and_papper_noise:
