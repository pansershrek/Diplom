...
x = [[y, y, y, y] for y in range(1, 101)]
x_validate = [[y + 0.5, y + 0.5, y + 0.5, y + 0.5] for y in range(0, 100)]

approximate_options8_3 = [
    {
        ...
        "params": convert_variables([5 for x in range(25)]),
...
"""
approximate_options8_3_white_noise = [
    copy.deepcopy(x) for x in approximate_options8_3
]
for x in approximate_options8_3_white_noise:
    x["noise_type"] = "white_noise"
    x["seed"] = 42

approximate_options8_3_gaussian_noise = [
    copy.deepcopy(x) for x in approximate_options8_3
]
for x in approximate_options8_3_gaussian_noise:
    x["noise_type"] = "gaussian_noise"
    x["seed"] = 42
    x["mean"] = 1
    x["std"] = 5

approximate_options8_3_salt_and_papper_noise = [
    copy.deepcopy(x) for x in approximate_options8_3
]
for x in approximate_options8_3_salt_and_papper_noise:
