...
x_validate = generate_x(
    np.array([0, 0, 0]), np.array([100, 100, 100]), 1, 41
)

approximate_options7_1 = [
    {
...
for x in approximate_options7_1_gaussian_noise:
    x["noise_type"] = "gaussian_noise"
    x["seed"] = 42
    x["mean"] = 1
    x["std"] = 5

approximate_options7_1_salt_and_papper_noise = [
    copy.deepcopy(x) for x in approximate_options7_1
]
for x in approximate_options7_1_salt_and_papper_noise:
